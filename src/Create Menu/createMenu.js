...
function getMenu(userChannel, channelBoldTags) {
    ...
    const menuFields = {
        ...
        /* options: { //This option structure allows you to create a menu separated by sessions (For Whatsapp-list and text menus, only). For Whatsapp list menu, it has a maximum of 10 options (regardless of the number of sessions)
            'en-US': {
    ...
    return  createMenu(props, config);
}
